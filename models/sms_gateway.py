...
class VlSmsGateway(models.AbstractModel):
    ...
    def _get_config(self):
        ...
        return {
            ...
            "signup_enabled": icp.get_param("vl_otp_auth.signup_enabled", "False") == "True",
            "checkout_enabled": icp.get_param("vl_otp_auth.checkout_enabled", "False") == "True",
    ...
    @api.model
    def _assert_gateway_configured(self):
    ...
    @api.model
    def _assert_feature_ready(self, feature):
        cfg = self._assert_gateway_configured()
        feature_key = {
            "login": "login_enabled",
            "signup": "signup_enabled",
            "checkout": "checkout_enabled",
        }.get(feature)
        if feature_key and not cfg[feature_key]:
