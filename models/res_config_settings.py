...
class ResConfigSettings(models.TransientModel):
    ...
    signup_enabled = fields.Boolean(
        string="Enable OTP Website Signup",
        config_parameter="vl_otp_auth.signup_enabled",
    )
    checkout_enabled = fields.Boolean(
        string="Require OTP Before Website Payment",
        config_parameter="vl_otp_auth.checkout_enabled",
    )
